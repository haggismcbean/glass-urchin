...
function PixGallery_Initialize()
{
	...
	PreloadedImage[0].src = "http://glassurchin.nerdcomics.com/wp-content/plugins/awsompixgallery/images/loading.gif";
	PreloadedImage[1] = new Image();
	PreloadedImage[1].src = "http://glassurchin.nerdcomics.com/wp-content/plugins/awsompixgallery/images/background.gif";
